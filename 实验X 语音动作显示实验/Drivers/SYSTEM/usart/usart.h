...
#define MAX_IMG_BYTES   6144
typedef enum { RX_MODE_LINE = 0, RX_MODE_IMG = 1 } rx_mode_t;
...
extern volatile rx_mode_t g_rx_mode;
extern volatile uint8_t g_img_rx_done;
extern uint8_t g_img_buf[MAX_IMG_BYTES];
